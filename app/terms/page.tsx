...
const SECTIONS: LegalSection[] = [
  ...
  { n: "05", title: "No unsupported claims", body: "SealRail labels live verification honestly and does not claim hosted TEE execution before the underlying service is connected." },
