  ...
  return (
    <div className={styles.page}>
      ...
      <main id="main" tabIndex={-1} className={styles.wrap} style={{ maxWidth: 980 }}>
        <div className={styles.eyebrow}>Judge quickstart</div>
        <h1 className={styles.title}>Evaluate Sealrail in 60 seconds.</h1>
        <p className={styles.lead}>
          Sealrail is submitted to the Casper Innovation Track as Agentic AI + RWA payment infrastructure:
          agents do work, verifiers prove it, Casper anchors it, and payment unlocks only after proof.
        </p>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>
              <strong>RWA:</strong> the primary demo scores invoice risk before payment release.
            </li>
            <li>
